...
/** End paid access — return to limited Free plan (public allowed). */
...
/**
 * Sync billing state: expire finished Pro trials to Free.
 * Does not auto-start trials — Free is the default permanent tier.
 */
